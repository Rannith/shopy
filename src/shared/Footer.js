                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-sm-6 col-md-3 item">
                                    ...
                                    <img src='https://gjoa.demosphere-secure.com/_uploads/57645180dfa3fe367ff30f16/ADIDAS_LOGO_WHITE_SILHOUETTE_SHADOW_BORDER.png' className='mt-5' alt='logo' width='100px' height='45px' />
                                </div>
                                <div className="col-sm-6 col-md-3 item">
